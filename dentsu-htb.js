...
var PartnerSpecificValidator = require('dentsu-htb-validator.js');
...
function DentsuHtb(configs) {
    ...
    */
    ...
    (function __constructor() {
        ...
        __profile = {
            partnerId: 'DentsuHtb', // PartnerName
            namespace: 'DentsuHtb', // Should be same as partnerName
            statsId: 'DENTSU', // Unique partner identifier
            version: '2.1.1',
            targetingType: 'slot',
            enabledAnalytics: {
                requestTime: true
